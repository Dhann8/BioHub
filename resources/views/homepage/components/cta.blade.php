  <section id="cta" class="py-20 bg-[#F9FAFB]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="relative bg-[#2E7D32] rounded-3xl overflow-hidden px-8 md:px-16 py-14 text-center">
        <img class="absolute inset-0 w-full h-full object-cover opacity-10" src="https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_c8ae52cc36_979e24f81d00c09b.png" alt="tropical leaves pattern botanical illustration, dark green, seamless background" />
        <div class="relative z-10">
          <div class="inline-flex items-center gap-2 bg-white/20 text-white text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
            <i class="fa-solid fa-globe"></i> BERGABUNG BERSAMA KAMI
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#" class="bg-white/15 hover:bg-white/25 border border-white/40 text-white font-bold px-8 py-4 rounded-xl text-sm transition">
              <i class="fa-solid fa-play mr-2"></i>Tonton Demo
            </a>
          </div>
        </div>
      </div>
